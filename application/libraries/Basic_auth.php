...
class Basic_auth
{
    ...
    protected $unprotected_methods = array();
    ...
    public function set_unprotected_methods($config)
    {
        $this->unprotected_methods = $config;
    }
    ...
    protected function method_is_protected()
    {
        ...
        {
            return !in_array($this->method, $this->unprotected_methods);
    ...
    protected function create_authtoken($userid)
    {
        ...
        {
            return sha1($userid . $this->config['tokensalt'] . $this->users[$userid]);
        }
        else
        {
            return FALSE;
